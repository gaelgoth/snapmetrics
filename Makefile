...
release:          ## Create a new tag for release.
	...
	@echo "$${TAG}" > snapmetrics/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@git add snapmetrics/VERSION HISTORY.md
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "snapmetrics = 'snapmetrics.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run snapmetrics'"
